...
Sou apaixonado por tecnologia, formado em engenharia de software. Aprendizado contínuo e pela transformação que a programação pode gerar na vida das pessoas. Tenho sólidos conhecimentos em **JavaScript**, **React**, **Node.js**, **TypeScript**, **Docker**, **SQL**, entre outras tecnologias do ecossistema web.
